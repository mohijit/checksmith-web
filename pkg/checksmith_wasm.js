/* @ts-self-types="./checksmith_wasm.d.ts" */
...
export class Game {
     ...
     * @param {boolean} use_nnue
     * @returns {any}
     */
    engine_move(movetime_ms, use_nnue) {
        const ret = wasm.game_engine_move(this.__wbg_ptr, movetime_ms, use_nnue);
        return ret;
    }
    /**
     * @returns {string}
     ...
     */
    has_nnue() {
        const ret = wasm.game_has_nnue(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    in_check() {
        const ret = wasm.game_in_check(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     */
    is_checkmate() {
        const ret = wasm.game_is_checkmate(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {boolean}
     ...
     */
    is_stalemate() {
        const ret = wasm.game_is_stalemate(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     * @returns {string[]}
     */
    legal_moves_uci() {
        const ret = wasm.game_legal_moves_uci(this.__wbg_ptr);
    ...
    load_nnue_bytes(bytes) {
        ...
        const ret = wasm.game_load_nnue_bytes(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
    ...
    new_game(fen) {
        var ptr0 = isLikeNone(fen) ? 0 : passStringToWasm0(fen, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.game_new_game(this.__wbg_ptr, ptr0, len0);
    }
    /**
    ...
    player_move(uci) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.game_player_move(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
    /**
     * @returns {string}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('checksmith_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
